...
<body>
    <div class="ms-3">
        <p class="fs-4 fw-bold">Clientes</p>
    </div>
    <!-- DELETE MODAL -->
<div class="modal fade" id="deleteCliente" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form action="{{route('delCliente')}}" method ="post">
            @csrf
            @method('delete')
...
<div class="modal fade" id="createCliente" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{route('regCliente')}}" method ="post">
            <div class="modal-body">
                @csrf
                <!-- <form action="#" method ="post"> -->
                    <div class="input-group mb-3">
                        <label class="control-label input-group-text" for="nombre">Nombre empresa</label>
                        <input type="text" name="nombre" id="nombre" placeholder="" class="form-control">
                    </div>
                    <div class="input-group mb-3">
                        {{-- <label class="control-label input-group-text" for="edo">Estado</label>
                        <input type="text" name="edo" id="edo" placeholder="" class="form-control"> --}}
                        <label for="estado" class="control-label input-group-text">Estado</label>
                        <select id="edo" name="edo" onchange="cargarCiudades();" class="form-select">
                            <option value="" disabled selected>Seleccione un estado</option>
                        
                        </select>
                    </div>
                    <div class="input-group mb-3">
                        {{-- <label class="control-label input-group-text" for="city">Ciudad</label>
                        <input type="text" name="city" id="city" placeholder="" class="form-control"> --}}
                        <label for="city" class="control-label input-group-text">Ciudad</label>
...
<div class="modal fade" id="editCliente" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{route('editCliente')}}" method ="post">
            <div class="modal-body">
                @csrf
                ...
                <!-- <form action="#" method ="post"> -->
                    ...
                    <div class="input-group mb-3">
                        <label class="control-label input-group-text" for="nombre">Empresa</label>
                        <input type="text" name="nombre" id="name" placeholder="" class="form-control">
                    </div>
                    <div class="input-group mb-3">
                        <label class="control-label input-group-text" for="city">Ciudad</label>
                        <input type="text" name="city" id="ciudad" placeholder="" class="form-control">
                    </div>
                    <div class="input-group mb-3">
                        <label class="control-label input-group-text" for="edo">Estado</label>
                        <input type="text" name="edo" id="estado" placeholder="" class="form-control">
                    </div>
    ...
    <thead class='table-dark'>
       <button type='button' class='btn btn-outline-success' data-bs-toggle='modal' data-bs-target='#createCliente'>
    Agregar
    </button>
    <br>
    <br>
...
function cargarCiudades() {
    ...
    var estados = document.getElementById('edo')
    var ciudades = document.getElementById('city')
