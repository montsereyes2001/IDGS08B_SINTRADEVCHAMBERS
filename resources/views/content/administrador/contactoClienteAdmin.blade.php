...
<body>
    <div class="ms-3">
        <p class="fs-4 fw-bold">Contacto cliente</p>
    </div>
    <!-- DELETE MODAL -->
<div class="modal fade" id="deleteConcli" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form action="{{route('delConcli')}}" method ="post">
            @csrf
            @method('delete')
...
<!-- INSERT MODAL ##############################################################################-->
<div class="modal fade" id="createConcli" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{route('regConcli')}}" method ="post">
            <div class="modal-body">
                @csrf
                <!-- <form action="#" method ="post"> -->
                    <div class="input-group mb-3">
                        <label class="control-label input-group-text" for="cliente">Cliente</label>
                        <select class="form-select" name="cliente" id="cliente" aria-label="Default select example">
                        <?php
                        foreach ($clientes as $cli){
                            echo'<option value="'.$cli->id.'">'.$cli->nombre_empresa.': '.$cli->ciudad.', '.$cli->estado.'</option>';
                        }
                        ?>
                        </select>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="email" id="email" placeholder="alguien@example.com" class="form-control">
                    </div>
                    <div class="input-group mb-3">
                        <label class="control-label input-group-text" for="puesto">Cargo</label>
                        <input type="text" name="puesto" id="puesto" placeholder="Ej: Supervisor" class="form-control">
                    </div>
                    <div class="input-group mb-3">
...
<div class="modal fade" id="editConcli" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="{{route('editConcli')}}" method ="post">
            <div class="modal-body">
                @csrf
                ...
                <!-- <form action="#" method ="post"> -->
                    ...
                    <div class="input-group mb-3">
                        <label class="control-label input-group-text" for="cliente">Cliente</label>
                        <input type="text" name="cliente" id="clien" placeholder="" class="form-control"  disabled>
                    </div>
                    <div class="mb-3">
                        <p> Datos del Contacto </p>
                    </div>
                    <div class="input-group mb-3">
                        <label class="control-label input-group-text" for="name">Nombre</label>
                        <input type="text" name="name" id="nombre" placeholder="" class="form-control">
                    </div>
                    <div class="input-group mb-3">
                        <label class="control-label input-group-text" for="email">Correo</label>
                        <input type="text" name="email" id="correo" placeholder="alguien@example.com" class="form-control">
                    </div>
                    <div class="input-group mb-3">
                        <label class="control-label input-group-text" for="puesto">Cargo</label>
                        <input type="text" name="puesto" id="cargo" placeholder="Ej: Supervisor" class="form-control">
                    </div>
                    <div class="input-group mb-3">
                        <label class="control-label input-group-text" for="tel">Telefono</label>
                        <input type="text" name="tel" id="tele" placeholder="" class="form-control">
                    </div>
   ...
   echo "<table id='table_user' class='table responsive' width='100%'>
    <thead class='table-dark'>
       <button type='button' class='btn btn-outline-success' data-bs-toggle='modal' data-bs-target='#createConcli'>
    Agregar
    </button>
    <br>
    <br>
    <tr>
        ...
        <th class='text-center d-none'>Id_Cliente</th>
    ...
    foreach($response as $row)
    {
        ...
        echo"<td class='text-center '> $row->contacto_nombre</td>";
        echo"<td class='text-center '> $row->contacto_email</td>";
        echo"<td class='text-center '> $row->contacto_cargo</td>";
