...
<body>
    <div class="ms-3 mt-3 mb-5 text-start container">
        <a class="btn btn-outline-dark align-item-center" id="btn-reg" href='<?php echo env('URL').'admin/gallery/'.$evidencia->id_bitacora;?>'><span
   ...
   @if(Session::has('message'))
                ...
                <div class="col-sm-7">
                    <div class="card-body">
                        ...
                        <button class="btn btn-outline-primary" data-bs-toggle="modal"
                            data-bs-target="#editarEvidencia">Editar</button>
                        <button class="btn btn-outline-danger" data-bs-toggle="modal"
                            data-bs-target="#eliminarEvidencia">Eliminar</button>
    ...
    <!--MODAL EDITAR !-->
    <form action="{{route('modEviAdmin')}}" method="post">
        @csrf
        @method('PUT')
        <div class="modal fade" id="editarEvidencia" tabindex="-1" aria-labelledby="editarEvidenciaLabel"
            aria-hidden="true">
    ...
    <div class="modal fade" id="eliminarEvidencia" tabindex="-1" aria-labelledby="editarEvidenciaLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('delEviAdmin', ['id' => $evidencia->id, 'idbit' => $evidencia->id_bitacora])}}"
                    method="post">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
