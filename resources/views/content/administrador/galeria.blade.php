...
<div class="ms-3 mt-3 text-start container">
    <a class="btn btn-outline-dark align-item-center" href='<?php echo env('URL').'admin/registros';?>'><span
...
<div class="alert alert-danger" role="alert">
    <h3 class="text-center">{{ Session::get('messagedelete') }}</h3>
</div>
@endif
<div class="ms-5 mt-3">
    <a class="btn btn-outline-dark align-item-center" href='<?php echo env('URL').'admin/bit/view/'.$id_bit;?>'>Agregar Fotos</a>
    @if (!isset($message))
            ...
            <div class="col-12 col-md-6 col-lg-3 carta">
                <div class="card mb-2">
                    ...
                    <div class="card-body">
                        ...
                        <a href="'.route('EvidenciaAdmin', $ev->id).'" class="btn btn-outline-warning" style="color: yellow;">Ver
                            más</a>
                    </div>
                </div>
            </div>
