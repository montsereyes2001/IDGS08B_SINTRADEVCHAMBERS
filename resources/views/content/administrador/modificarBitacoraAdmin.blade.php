...
<body>
    ...
    @endif
    <div class="p-3">
        <h2 class="text-center mb-4">Modificación de registro</h2>
        @switch($ttrabajo[0]->nombre)
        @case('Troncal')
        <form action="{{route('editarBtcAdmin',[ $id_bitacora])}}" method="post" class="row g-3">
            @csrf
            @method('PUT')
            <div class="col-md-6">
    ...
    ?>
            ...
            <div class="col-md-6">
                ...
                <div class="form-check">
                    ...
                    <input class="form-check-input" type="checkbox" name="materials[]" value="{{ $item->id }}"
                        {{in_array($item->id,
