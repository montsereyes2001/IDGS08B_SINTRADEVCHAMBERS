...
{{-- http://192.168.101.4/admin/gallery/101 --}}
<body>
    <div class="ms-3 mt-3 text-start container">
        <a class="btn btn-outline-dark align-item-center" id="btn-reg" href='<?php echo env('URL').'admin/gallery/'.$id_bitacora;?>'><span
    ...
    <div class="p-3">
        ...
        <form action="{{ route('regEvidencia') }}" method="post" enctype="multipart/form-data" class="row g-3">
            ...
            <div class="col-12 text-center mt-4">
                <button type="submit" name="" class="btn btn-outline-dark align-item-center" id="">Guardar
                    Cambios</button>
            </div>
        </form>
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->prodmatbit }} <input required type="hidden" value={{ $item->idmats }}
                                    class="form-control" name="prodmat[]"></td>
                                <td><input required class=" form-control w-85" type="number" name="cantmat[]" id="cant">
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
