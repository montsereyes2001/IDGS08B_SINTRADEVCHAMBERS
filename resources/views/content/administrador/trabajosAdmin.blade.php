...
<body>
        <div class="ms-3 mt-3">
        <p class="fs-4 fw-bold">Trabajos</p>
    </div>
    <!-- DELETE MODAL -->
<div class="modal fade" id="deleteTrab" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form action="{{route('delTrab')}}" method ="delete">
            @csrf
        <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="delete" class="btn btn-danger">Aceptar</button>
            </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="createTrab" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{route('regTrab')}}" method ="post">
            <div class="modal-body">
                @csrf
...
<div class="modal fade" id="editTrab" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="{{route('editTrab')}}" method ="post">
            <div class="modal-body">
                @csrf
                @method('put')
                <!-- <form action="#" method ="post"> -->
    ...
    <?php
   echo'<div class="ms-3 me-5" style="align-text:center !important"> ';
    echo "<table id='table_user' class='table table-hover text-center display'>
    <thead class='table-dark'>
    <button type='button' class='btn btn-outline-success'data-bs-toggle='modal' data-bs-target='#createTrab'>
    Agregar
    </button>
    <br>
    <br>
