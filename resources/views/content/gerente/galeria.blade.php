...
<div class="ms-3 mt-3 text-start container">
    <a class="btn btn-outline-dark align-item-center" href='<?php echo env('URL').'ger/registros';?>'><span class="ms-1 d-sm-inline bi bi-arrow-bar-left fs-4"></span>&nbsp;Regresar</a>
    </div>
...
<div class="ms-5 mt-3">
    @if (!isset($message))
   <a class="btn btn-outline-dark align-item-center" href='<?php echo env('URL').'bit/view/ger/'.$id_bit;?>'>Agregar Fotos</a>
            ...
            <div class="col-12 col-md-6 col-lg-3 carta">
                <div class="card mb-2">
                    ...
                    <div class="card-body">
                        ...
                        <a href="'.route('EvidenciaGerente', $ev->id).'" class="btn btn-outline-warning" style="color: yellow;">Ver
                            más</a>
                    </div>
                </div>
            </div>
