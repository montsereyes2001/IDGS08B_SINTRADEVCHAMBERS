        ...
        <div class="input-group mb-3 flex-nowrap">
         ...
         <div class="input-group mb-3 flex-nowrap">
            ...
            <div class="input-group mb-3 flex-nowrap">
                ...
                <input class="form-control" type="date" id="end" name="end" value="<?php $date=date('Y-m-d'); echo $date;?>"
