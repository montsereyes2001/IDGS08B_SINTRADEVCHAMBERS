  ...
  <div class="p-3">
    ...
    <form action="{{route('regBitacora')}}" method="post" class="row g-3">
      ...
      <div class="col-md-6">
        ...
        <select name="tipo_trabajo" id="tptrab" class="form-select">
      ...
      <div class="col-12">
        ...
        <select id="" name="lider" class="form-select">
          <?php
      echo '<option value="'.$lider.'">'.$lider.'</option>';
    ?>
        </select>
      </div>
      <div class="col-md-6">
      ...
      <div class="col-12 ms-3">
        ...
        <label class="form-check-label d-none" for="material-select-all" id="material-select-all-label">Seleccionar todos</label>
      </div>
      <div class="col-12 ms-3">
        <div class="form-check" id="material">
        </div>
        <div class="col-12 text-center mt-4" id="regbit">
          <button type="submit" class="btn btn-outline-dark align-item-center" id="btn-reg">Registrar bitacora</button>
        </div>
    </form>
  </div>
  <!-- 
