...
<div class="ms-3 mt-3 text-start container">
    <a class="btn btn-outline-dark align-item-center" href='<?php echo env('URL').'bit/cards';?>'><span class="ms-1 d-sm-inline bi bi-arrow-bar-left fs-4"></span>&nbsp;Regresar</a>
</div>
            ...
            <div class="col-12 col-md-6 col-lg-3 carta">
                <div class="card mb-2">
                    ...
                    <div class="card-body">
                        ...
                        <a href="'.route('getFotoEv', $ev->id).'" class="btn btn-outline-warning" id="btnvermas" style="color: yellow;">Ver
                            más</a>
                    </div>
                </div>
            </div>
