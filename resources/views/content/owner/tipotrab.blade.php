    ...
    <p><h1 class='text-center'>Listado de registros</h1></p>
        ...
        <div class="input-group mb-3 flex-nowrap">
            ...
            <div class="input-group mb-3 flex-nowrap">
                ...
                <input class="form-control disabled" type="text" disabled name="trabajo" id="trabajo" value="<?php echo $trabajoTipo;
                ?>">
            </div>
            <div class="input-group mb-3 flex-nowrap">
