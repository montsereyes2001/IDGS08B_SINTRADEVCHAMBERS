    ...
    <p><h1 class='text-center'>Listado de registros</h1></p>
        ...
        <div class="input-group mb-3 flex-nowrap">
            ...
            <div class="input-group mb-3 flex-nowrap">
                ...
                <?php
                foreach($tipos as $t){
                    if($t->nomTipo == 'Troncal' || $t->nomTipo == 'Enlace' || $t->nomTipo == 'Distribución'){
                    ...
                    data.forEach(item => {
                        switch(item.estatus){
                            case 'En progreso':
                                ...
                                break;
                            case 'Terminado':
                                var progress = $("<div>").addClass('progress').append($("<div>").addClass('progress-bar bg-success progress-bar-striped').attr({role:"progressbar",style:"width:100%"}).text('Terminado'));
                                break;
                        }
                       ...
                       $(".row").append(
                            $("<div>").addClass("col-md-4 col-sm-12 mb-2").append(
                            $("<div>").addClass("card p-3 mb-2").append(
            ...
            $.ajax({
                ...
                success: function(data){ 
                    ...
                    data.forEach(item => {
                        ...
                        .append(progress)).append($("<div>").addClass("card__button").append($("<a>").attr({href:"../ev/get/"+item.id}).text("Ver más") ) )),
                        );
                });
                function getPageList(totalpages, page, maxLength){
                    function range(start, end){
